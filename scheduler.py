...
def init_scheduler(app: Flask):
    ...
    # Schedule the scraper to run every minute to fetch page 1 with 24 tenders
    scheduler.add_job(
    ...
    # Start the scheduler
    scheduler.start()
    logger.info("Scheduler started, scraper will run every minute fetching 24 tenders from page 1")
